...
public class NewsModelAssembler
    implements RepresentationModelAssembler<NewsDtoResponse, NewsDtoResponse> {
  ...
  public NewsDtoResponse toModel(NewsDtoResponse news) {
    ...
    news.add(Link.of(linkBuilder.buildResourceLink(AuthorController.class, news.getId()), "self"));
    ...
    news.add(
        Link.of(
            linkBuilder.buildNestedResourceLink(NewsController.class, news.getId(), "author"),
            "author"));
    news.add(
        Link.of(
            linkBuilder.buildNestedResourceLink(NewsController.class, news.getId(), "tags"),
            "tags"));
    news.add(
        Link.of(
            linkBuilder.buildNestedResourceLink(NewsController.class, news.getId(), "comments"),
            "comments"));
  ...
  @Override
  public CollectionModel<NewsDtoResponse> toCollectionModel(
      Iterable<? extends NewsDtoResponse> entities) {
    CollectionModel<NewsDtoResponse> newsModels =
