...
public class CommentController
  ...
  @Operation(
      ...
      description = "Modifies a comment's content by its ID")
  @ApiResponses(
      value = {
  ...
  public CommentsDtoResponse update(
      @PathVariable Long id, @RequestBody CommentsDtoRequest dtoRequest) {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "204",
            description = "Successfully deletes the specific comment"),
        @ApiResponse(
            responseCode = "401",
            description = "You are not authorized to view the resource"),
        @ApiResponse(
