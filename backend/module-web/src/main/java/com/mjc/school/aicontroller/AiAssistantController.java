...
public class AiAssistantController {
  ...
  @Operation(
      ...
      description =
          "Sends a user message to the AI assistant and returns a response, including relevant news article IDs if found")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Returns the full conversation history for a given session ID")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description = "Deletes all messages for a given session ID")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "204",
            description = "Successfully cleared the conversation history"),
        @ApiResponse(
            responseCode = "401",
            description = "You are not authorized to view the resource"),
        @ApiResponse(responseCode = "404", description = "Session not found")
