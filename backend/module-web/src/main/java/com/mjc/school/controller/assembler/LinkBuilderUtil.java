...
public class LinkBuilderUtil {
  ...
  public String buildNestedResourceLink(
      Class<?> controllerClass, Object parentId, String nestedResource) {
    String baseLink = buildResourceLink(controllerClass, parentId);
    return baseLink + "/" + nestedResource;
  }

  public String buildNestedResourceLinkForMethod(
      Class<?> controllerClass, String methodName, Object parentId, String nestedResource) {
  ...
  private String getApiVersionFromController(Class<?> controllerClass, String methodName) {
    try {
      ...
      log.error(
          "Could not extract API version from {}{}: {}",
