...
public class NewsController
  ...
  @Operation(
      summary = "View all news",
      description = "Returns a paginated list of all news articles")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Returns a single news article by its ID")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Modifies an existing news article by its ID")
  @ApiResponses(
      value = {
  ...
  public NewsDtoResponse update(
      @PathVariable Long id, @RequestBody UpdateNewsDtoRequest dtoRequest) {
  ...
  @Operation(
      summary = "Get tags for a news article",
      description = "Returns all tags associated with a specific news article")
  @ApiResponses(
      value = {
  ...
  @Operation(
      summary = "Get author of a news article",
      description = "Returns the author information for a specific news article")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Returns all comments associated with a specific news article")
  @ApiResponses(
      value = {
