...
class CommentServiceTest {
  ...
  @Mock private CommentsSearchFilterMapper commentSearchFilterMapper;
  ...
  void setUp() {
    ...
    commentDtoResponse =
        new CommentsDtoResponse(
            1L, "Spring Boot", 1L, "Commentator", LocalDateTime.now(), LocalDateTime.now());
  }
