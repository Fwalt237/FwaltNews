...
class CaffeineServiceCacheTest {
  ...
  void newsUpdate_putAndEvict() {
    ...
    UpdateNewsDtoRequest req =
        new UpdateNewsDtoRequest("Updated Title", null, null, null, null, null, null);
    // When
  ...
  private void initTestData() {
    ...
    this.commentDtoResponse =
        new CommentsDtoResponse(1L, "Spring Boot", 1L, "Commentator", now, now);
    this.commentsDtoForNewsResponse = new CommentsDtoForNewsResponse(1L, "Spring Boot", now, now);
    this.newsDtoResponse =
        new NewsDtoResponse(
            1L,
            "Java",
            "Language",
            ...
            List.of(commentsDtoForNewsResponse));
  }
