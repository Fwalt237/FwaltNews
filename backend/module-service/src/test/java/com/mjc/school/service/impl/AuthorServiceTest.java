...
class AuthorServiceTest {
  ...
  @Mock private AuthorSearchFilterMapper authorSearchFilterMapper;
  ...
  void setUp() {
    ...
    authorDtoResponse =
        new AuthorDtoResponse(1L, "James", LocalDateTime.now(), LocalDateTime.now());
  }
  ...
  void readAll_ShouldReturnPagedAuthors() {
    ...
    when(authorSearchFilterMapper.map(any()))
        .thenReturn(
    ...
    verify(authorRepository)
        .findAll(ArgumentMatchers.<Specification<Author>>any(), any(Pageable.class));
  }
