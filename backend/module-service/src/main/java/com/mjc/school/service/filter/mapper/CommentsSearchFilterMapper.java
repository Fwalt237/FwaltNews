...
@Component
public class CommentsSearchFilterMapper
    extends BaseSearchFilterMapper<ResourceSearchFilterRequestDTO> {

  @Override
  public List<Sorting> getDefaultSorting() {
    return List.of(new Sorting("createdDate", SortOrder.DESC));
  }
